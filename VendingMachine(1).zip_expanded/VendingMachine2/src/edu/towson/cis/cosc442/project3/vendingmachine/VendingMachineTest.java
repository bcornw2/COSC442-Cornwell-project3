 ...
 *
 * @generatedBy CodePro at 3/7/18 11:08 PM
 * @author BCC1117
...
public class VendingMachineTest {
	...
	public void testGetSlotIndex() {
		...
		assertEquals(0, vend1.getSlotIndex("A"), 0.0001);
		assertEquals(1, vend1.getSlotIndex("B"), 0.0001);
		assertEquals(2, vend1.getSlotIndex("C"), 0.0001);
		assertEquals(3, vend1.getSlotIndex("D"), 0.0001);
		
		//assertEquals("Invalid amount.  Amount must be >= 0", vend1.getSlotIndex("Q"));
	}
	@Test(expected = VendingMachineException.class)
	public void testVendingMachineException_AddItem() {
		VendingMachine vend1 = new VendingMachine();
		VendingMachineItem item = new VendingMachineItem("Meth", 20.00);
	    vend1.addItem(item, "A");
	    VendingMachineItem item2 = new VendingMachineItem("Crack", 10.00);
	...
	public void testMakePurchase1() {
		VendingMachineItem item = new VendingMachineItem("cigarettes", 7.50);
		VendingMachine vend1 = new VendingMachine();
		vend1.addItem(item, "A");
		vend1.insertMoney(10);
